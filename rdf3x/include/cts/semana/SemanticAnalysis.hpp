...
class SemanticAnalysis
{
   ...
   //Jyoti -begin
   //this method has been created to lookup the node and find out its outgoing edges i.e. predicate and object
   void lookupNode(std::string& text, Type::ID type,unsigned subType,unsigned& id);
   //Jyoti --end
};
//---------------------------------------------------------------------------
#endif
