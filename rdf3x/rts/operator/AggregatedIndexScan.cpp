...
//   cout<<"\n subject->value="<<subject->value;
   //cout<<"\n Subject Bound="<<subjectBound;
   //cout<<"\n predicate->value="<<predicate->value;
   //cout<<"\n Predicate Bound="<<predicateBound;
//   cout<<"\n object->value="<<object->value;
   //cout<<"\n Object Bound="<<objectBound;
   //cout<<"\n Expected Output Cardinality="<<expectedOutputCardinality;
   bool bound1=false,bound2=false;
   switch (order) {
      case Database::Order_Subject_Predicate_Object:
         value1=subject; value2=predicate;
         //cout<<"\n predicate value2="<<value2->value;
